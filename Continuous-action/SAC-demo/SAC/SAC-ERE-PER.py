...
parser.add_argument("-info", type=str, default='SAC-ERE-PER', help="tensorboard test run information")
parser.add_argument("-device", type=str, default="cpu", help="Change to CPU computing or GPU, default=cuda:0")
