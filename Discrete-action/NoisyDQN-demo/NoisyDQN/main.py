...
agent = NoisyAgent(env.observation_space.shape[0], env.action_space.n, args)

writer = SummaryWriter('../../runs/{}_NoisyDQN_{}'.format(datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S'), args.env_name))
